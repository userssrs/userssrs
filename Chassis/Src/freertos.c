...
osThreadId NRF24L01_taskHandle;
...
void MX_FREERTOS_Init(void)
{
  ...
  osThreadDef(NRF24L01Task, NRF24L01_task, osPriorityRealtime, 0, 512);
  NRF24L01_taskHandle = osThreadCreate(osThread(NRF24L01Task), NULL);
